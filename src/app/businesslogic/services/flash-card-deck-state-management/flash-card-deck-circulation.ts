...
export function increaseCirculation(deck: FlashCardDeck, n: number | null): FlashCardDeck {
...
export function decreaseCirculation(deck: FlashCardDeck, n: number | null): FlashCardDeck {
  const cards = [...deck.cards];
  if (n === null) {
